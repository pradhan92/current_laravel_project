...
<head>
  ...
  <title>ShoesHouse || Login</title>
  <!-- General CSS Files -->
  <link rel="stylesheet" href="/backend/assets/css/app.min.css">
  <link rel="stylesheet" href="/backend/assets/bundles/bootstrap-social/bootstrap-social.css">
  <!-- Template CSS -->
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="{{ route('admin.register') }}">Register Now</a>
            </div>
          </div>
        </div>
      </div>
