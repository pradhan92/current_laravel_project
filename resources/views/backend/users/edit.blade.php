    ...
    <div class="card-body">
      <form method="post" action="{{route('users.update',$user->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="address" type="email" name="email" placeholder="Enter email"  value="{{$user->address}}" class="form-control">
          @error('address')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
         <div class="form-group">
          ...
          <input id="phone" type="email" name="email" placeholder="Enter email"  value="{{$user->phone}}" class="form-control">
          @error('phone')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
